...
Please refer to {Travis CI}[https://travis-ci.org/whatagem/ipaddress] for Build Tests on specific versions of Ruby.

{<img src="https://travis-ci.org/whatagem/ipaddress.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/whatagem/ipaddress] {<img src="https://codeclimate.com/github/whatagem/ipaddress/badges/gpa.svg" />}[https://codeclimate.com/github/whatagem/ipaddress]

If you want to contribute, please refer to {Contributing.md}[https://github.com/whatagem/ipaddress/blob/master/CONTRIBUTING.md].
...
{this address}[http://www.rubydoc.info/gems/ipaddress/0.9.0]
